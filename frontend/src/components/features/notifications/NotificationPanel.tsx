...
export function NotificationPanel() {
  ...
  return (
    <div className="absolute right-0 top-full mt-2 w-full sm:w-96 bg-[#0F1115] border border-white/10 rounded-2xl shadow-[0_0_30px_rgba(247,147,26,0.15)] overflow-hidden z-50">
      {/* Header */}
