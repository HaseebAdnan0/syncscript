        ...
        {pathOptions.map((option) => {
          ...
          return (
            <button
              ...
              className="bg-[#0F1115] border border-white/10 rounded-2xl p-8 text-left hover:-translate-y-2 hover:border-[#F7931A]/50 hover:shadow-[0_0_30px_-10px_rgba(247,147,26,0.5)] transition-all duration-300 group"
            >
              <div
              ...
              <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-[#F7931A] transition-colors">
                {option.title}
              </h3>
