...
# Nested router for vault citations export (US-011, PRD14)
from apps.citations.views import VaultCitationExportViewSet
vaults_router.register(r'citations', VaultCitationExportViewSet, basename='vault-citations')
